...
> as we can see here in this graph, the first two priciple components  explain almost 70% of the variation in our data sets.
...
> to see which variables have the more impact (or contribution) on the variation of the principle components, we will analyze the contribution of each variable to first, second and third principale component, and both the first and the second principale components.
