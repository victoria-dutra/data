...
d5 <- d0[d0$Week == "W6" & d0$Species == "Solanum lycopersicum", c(4,7, 8, 11:21)]
d6 <- na.exclude(d5)

data2 <- d0[d0$Week == "W6" & d0$Species == "Solanum lycopersicum", c(8, 11:21)]
data3 <- na.exclude(data2)
